        ...
        <ul class="navbar-nav ms-auto align-items-center">
            ...
            <li class="nav-item dropdown nav-more" style="display:none;">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="<%=request.getContextPath()%>/home">Trang chủ</a></li>

                    <c:if test="${not empty sessionScope.currentUser}">
                        <li><a class="dropdown-item" href="<%=request.getContextPath()%>/favorites">Yêu thích</a></li>
                    </c:if>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a class="dropdown-item" href="<%=request.getContextPath()%>/login">Đăng nhập</a></li>
                            <li><a class="dropdown-item" href="<%=request.getContextPath()%>/register">Đăng ký</a></li>
                        </c:otherwise>
                    </c:choose>
