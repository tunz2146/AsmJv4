                                ...
                                <div class="info-card">
                                    ...
                                    <c:if test="${not empty suggestedVideos}">
                                        <div class="alert alert-success alert-sm mb-3 py-2">
                                            ...
                                            <small>Đã tải ${suggestedVideos.size()} video ngẫu nhiên</small>
                                        </div>
                                    </c:if>
                                    ...
                                    <c:choose>
                                        <c:when test="${empty suggestedVideos}">
                                            <div class="alert alert-info text-center py-4">
                                                ...
                                                <p class="mb-0"><small>Không có video đề xuất</small></p>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="suggested-videos-list">
                                                <c:forEach items="${suggestedVideos}" var="sv" varStatus="status">
                                                    <div class="suggested-video-card d-flex p-2 mb-2" 
                                                        ...
                                                        <div class="flex-grow-1 ps-3 d-flex flex-column justify-content-center">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <small class="text-muted">
                                                                    <code style="font-size: 0.75rem;">${sv.id}</code>
                                                                </small>
                                                            </div>
                                                        </div>
                                                    </div>
