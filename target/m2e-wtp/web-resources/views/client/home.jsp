                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="lead mb-0 opacity-90">
                            Khám phá những tiểu phẩm giải trí hấp dẫn
                        </p>
                    </div>
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        <!-- Nút Shuffle -->
                        <form method="post" action="<%=request.getContextPath()%>/home" style="display: inline;">
                            <input type="hidden" name="action" value="reshuffle">
                            <button type="submit" class="btn btn-light btn-lg btn-shuffle">
